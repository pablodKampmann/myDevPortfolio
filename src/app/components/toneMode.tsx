...
export default function ToneMode({ tone, colorMain, handleToneChange }: ToneOptionsProps) {
        ...
        const updateClassesTones = () => {
            ...
            switch (colorMain) {
                case 'emerald':
                    ...
                    bgColorMainHover = tone === 'dark' ? "hover:bg-emerald-500" : "hover:bg-emerald-500";

                    break;
                case 'rose':
                    bgColorMain = tone === 'dark' ? "bg-rose-600" : "bg-rose-600";
                    bgColorMainHover = tone === 'dark' ? "hover:bg-rose-500" : "hover:bg-rose-500";

                    break;
                case 'blue':
                    bgColorMain = tone === 'dark' ? "bg-blue-600" : "bg-blue-600";
                    bgColorMainHover = tone === 'dark' ? "hover:bg-blue-500" : "hover:bg-blue-500";

                    break;
                case 'yellow':
                    bgColorMain = tone === 'dark' ? "bg-yellow-600" : "bg-yellow-600";
                    bgColorMainHover = tone === 'dark' ? "hover:bg-yellow-500" : "hover:bg-yellow-500";
