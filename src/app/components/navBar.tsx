        ...
        <div className={`w-full flex justify-between items-center ${classes?.bgMain} border-b-2 ${classes?.borderColor} transition select-none duration-200 ${classes?.bgMainOpacity} h-[10%] `} >
            ...
            <div className={`${classes?.textMain} flex space-x-4  justify-end items-center mr-4`}>
                <Link href={'/'} prefetch={true}>
                    <div className={`${pathname === '/' ? `bg-emerald-900  ${classes?.bgOpacityButtons} ` : `hover:${classes?.bgHoverButtons}`} cursor-pointer focus:outline-none  py-2 px-3 rounded-xl transition duration-150  w-full whitespace-nowrap`}><span className="text-emerald-500">01. </span>{texts?.about}</div>
                </Link>
                <Link href={'/work'} prefetch={true}>
                    <div className={`${pathname === '/work' ? `bg-emerald-900  ${classes?.bgOpacityButtons}` : `hover:${classes?.bgHoverButtons}`} cursor-pointer focus:outline-none py-2 px-3 rounded-xl transition duration-150  w-full whitespace-nowrap`}><span className="text-emerald-500">02. </span>{texts?.work}</div>
                </Link>
                <Link href={'/experience'} prefetch={true}>
                    <div className={`${pathname === '/experience' ? `bg-emerald-900  ${classes?.bgOpacityButtons}` : `hover:${classes?.bgHoverButtons}`} cursor-pointer focus:outline-none py-2 px-3 rounded-xl transition duration-150  w-full whitespace-nowrap`}><span className="text-emerald-500">03. </span>{texts?.experience}</div>
                </Link>
                <Link href={'/tech'} prefetch={true}>
                    <div className={`${pathname === '/tech' ? `bg-emerald-900  ${classes?.bgOpacityButtons}` : `hover:${classes?.bgHoverButtons}`} cursor-pointer focus:outline-none py-2 px-3 rounded-xl transition duration-150  w-full whitespace-nowrap`}><span className="text-emerald-500">04. </span>{texts?.technologies}</div>
                </Link>
