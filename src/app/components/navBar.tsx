        ...
        <div className="w-full flex justify-between items-center bg-blue-950 border-b-2 border-emerald-700 bg-opacity-20 h-[10%] ">
            ...
            <div className="flex space-x-4 justify-end items-center mr-4">
                ...
                <Link href={'/experience'} prefetch={true}>
                    <div className={`${pathname === '/experience' ? 'bg-emerald-900 bg-opacity-40' : 'hover:bg-emerald-900'} cursor-pointer py-2 px-3 rounded-xl transition duration-150  w-full whitespace-nowrap`}><span className="text-emerald-500">02. </span>{texts?.experience}</div>
                </Link>
                <Link href={'/tech'} prefetch={true}>
                    <div className={`${pathname === '/tech' ? 'bg-emerald-900 bg-opacity-40' : 'hover:bg-emerald-900'} cursor-pointer py-2 px-3 rounded-xl transition duration-150  w-full whitespace-nowrap`}><span className="text-emerald-500">03. </span>{texts?.technologies}</div>
                </Link>
